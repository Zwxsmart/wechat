...
import com.lanwantec.entity.resp.*;
...
public class MessageUtil {
	 ...
	 * 返回消息类型：图文
	 */
	public static final String RESP_MESSAGE_TYPE_NEWS = "news_lists";
    ...
    public static Map<String, String> parseXmlToMap(HttpServletRequest request) throws Exception {
        ...
        while (it.hasNext()) {
			...
			Map<String,String> maps = checkChildEle(element);
    ...
    public static Map<String,String> checkChildEle(Element element) throws DocumentException {
		Map<String,String> map = new HashedMap();
        List<Element> list = element.elements();
        if (list!=null&&list.size()>0) {
            for (Element ele : list) {
            	map.put(ele.getName(),ele.getText());
				map.putAll(checkChildEle(ele));
            }
        }
        return map;
    }
	 ...
	 * @return xml
	 */
	public static String imageMessageToXml(Image image) {
